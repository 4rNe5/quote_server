quote_list = [
  ...
  },
  {
    ...
    "message": "낙관주의자는 모든 기회에서 어려움을 보지만, 비관주의자는 모든 어려움에서 기회를 본다.",
  },
  {
    "author": "마더 테레사",
  ...
  },
  {
    ...
    "message": "상상력은 지식보다 중요하다. 지식은 한계가 있지만 상상력은 세상의 모든 것을 품는다.",
  },
  {
    "author": "에이브러햄 링컨",
    "authorProfile": "미국 16대 대통령",
    "message": "내가 걷는 이 길이 옳다는 것을 확신한다면, 나는 굴하지 않고 계속 나아갈 것이다.",
  },
  {
    "author": "간디",
  ...
  },
  {
    ...
    "message": "국가가 당신을 위해 무엇을 할 수 있을지 묻지 말고, 당신이 국가를 위해 무엇을 할 수 있을지 물어라.",
  },

  {
    "author": "스티브 잡스",
    "authorProfile": "미국 기업가, 애플 공동 창립자",
    "message": "당신의 시간은 제한되어 있습니다. 다른 사람의 인생을 사느라 시간을 낭비하지 마세요.",
  },
  {
    "author": "에이브러햄 링컨",
    "authorProfile": "미국 16대 대통령",
  ...
  },
  {
    ...
    "message": "20년 후, 당신은 하지 않은 일들 때문에 더 실망할 것이다. 그러니 안락의자를 벗어나라.",
  },
  {
    "author": "셰익스피어",
  ...
  },
  {
    ...
    "message": "모든 아이는 예술가다. 문제는 성인이 된 후에도 어떻게 예술가로 남을 수 있는가이다.",
  },
  {
    "author": "에이브러햄 링컨",
    "authorProfile": "미국 16대 대통령",
  ...
  },
  {
    ...
    "message": "나는 내 인생에서 9천 번 이상의 슛을 놓쳤다. 나는 수백 번의 경기를 패배했다. 그러나 실패를 거듭한 것이 내가 성공한 이유이다.",
  },
  {
    "author": "찰스 다윈",
    "authorProfile": "생물 학자, <종의 기원>의 저자",
  ...
  },
  {
    "author": "앨버트 아인슈타인",
    "authorProfile": "이론 물리학자",
    "message": "나는 특별한 재능이 있는 것이 아니다. 단지 열정적으로 호기심을 가질 뿐이다.",
  },
  {
    "author": "버락 오바마",
  ...
  },
  {
    "author": "윈스턴 처칠",
    "authorProfile": "영국 총리, 정치가",
    "message": "성공은 영원하지 않고, 실패도 치명적이지 않다. 중요한 것은 용기다.",
  },
  {
    "author": "미겔 데 세르반테스",
  ...
  },
  {
    "author": "마이클 앤젤로",
    "authorProfile": "이탈리아 르네상스 시대 화가, 조각가",
    "message": "작은 일이 완벽함을 만든다. 그러나 완벽함은 결코 작은 일이 아니다.",
  },
  {
    "author": "오드리 헵번",
    "authorProfile": "영국 출신 배우, 인도주의자",
    "message": "불가능이라는 단어는 단지 이 세상에 있는 단어일 뿐, 내 사전에 없다.",
  },
  {
    "author": "빈센트 반 고흐",
